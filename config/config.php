<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "LastingNest, inc.", 
			"phone" =>  "206-550-0326", 		  //either no format or dashed format
			"email" => "m.vacirca@comcast.net",   //by default is used as recipient email  
			"address" => "1806 NW 70th St, Seattle, WA, United States, 98117", 
